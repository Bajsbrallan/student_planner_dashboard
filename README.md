...
- **Cloud Sync:** Sign in with Google on the web version to sync your data across all devices
  **(Does NOT work yet on the pc build)**.

## Web Version
Access the app online:
[https://bajsbrallan.github.io/student_planner_dashboard](https://bajsbrallan.github.io/student_planner_dashboard)

## Local Setup (Desktop App)
1. Clone the repo
2. Run `npm install`
3. Launch with `npm start`
4. Build the installer with `npm run build`
